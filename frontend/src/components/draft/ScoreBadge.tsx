...
export default function ScoreBadge({ score }: ScoreBadgeProps) {
  ...
  return (
    <div className="relative grid size-[76px] shrink-0 place-items-center rounded-full bg-slate-950 p-1 shadow-xl shadow-black/30">
      ...
      <div className="relative grid size-full place-items-center rounded-full bg-slate-950">
        <div className="text-center">
          <p className={`text-2xl font-black leading-none ${tone.split(' ').at(-1)}`}>{score}</p>
